# contacts-rs coverage audit v2 (vs MacOSX26.2.sdk)
...
Comprehensive audit of Contacts.framework public declarations verified against MacOSX26.2.sdk. All top-level interfaces, protocols, enums, and constants are wrapped; 360 total symbols achieved 100% coverage via dedicated Rust types, enums, and safe accessors.
...
No gaps identified. All public macOS Contacts.framework symbols are covered by the crate.

## ⏭️ EXEMPT

No symbols were classified as exempt. Contacts.framework has no iOS-only symbols or deprecated APIs requiring exemption on macOS 26.2.
